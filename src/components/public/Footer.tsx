        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-5">
            ...
            <div className="flex gap-2">
              ...
              ].map(({ href, label, sublabel, icon }) => (
                <a
                  key={label}
                  href={href}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-1 items-center gap-2 rounded-lg px-3 py-2 text-white transition-opacity hover:opacity-80"
                  style={{ backgroundColor: "rgba(255,255,255,0.12)" }}
                >
                  {icon}
                  <div className="leading-tight">
                    <div style={{ fontSize: "9px", color: "#c5caf0" }}>{sublabel}</div>
